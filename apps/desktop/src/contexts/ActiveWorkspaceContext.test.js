...
import { ActiveWorkspaceProvider, useActiveWorkspace, } from "./ActiveWorkspaceContext";
...
function HookProbe() {
    ...
    return (_jsxs("div", { children: [_jsx("div", { "data-testid": "active-id", children: active?.id ?? "none" }), _jsx("div", { "data-testid": "active-name", children: active?.name ?? "" }), _jsx("div", { "data-testid": "ws-count", children: workspaces.length }), _jsx("div", { "data-testid": "loading", children: loading ? "yes" : "no" }), _jsx("button", { type: "button", "data-testid": "switch-w2", onClick: () => {
...
describe("ActiveWorkspaceContext Phase 8'.1", () => {
    it("초기 마운트 — list/getActive 호출 + active/list 갱신 + loading=false", async () => {
        ...
        render(_jsx(ActiveWorkspaceProvider, { children: _jsx(HookProbe, {}) }));
        await waitFor(() => {
