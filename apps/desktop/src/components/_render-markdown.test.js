...
import { escapeHtml, matchSection, parseSections, renderInline, renderMarkdown, } from "./_render-markdown";
describe("escapeHtml", () => {
...
describe("renderInline", () => {
    it("**bold** → strong, `code` → code", () => {
        expect(renderInline("plain **bold** text")).toContain("<strong>bold</strong>");
        expect(renderInline("use `npm install` here")).toContain("<code>npm install</code>");
    });
